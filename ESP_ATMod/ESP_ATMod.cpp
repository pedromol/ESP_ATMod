...
uint8_t gsCipMux = 1;				// command AT+CIPMUX
...
void setup()
{
	...
	gsSNTPServer[0] = "pool.ntp.br";
	gsSNTPServer[1] = "0.br.pool.ntp.org";
	gsSNTPServer[2] = "1.br.pool.ntp.org";
...
void setDns()
{
	...
	else
	{
		...
		dns_setserver(0, IPAddress(192, 168, 1, 132));
		dns_setserver(1, nullptr);
	}
}
